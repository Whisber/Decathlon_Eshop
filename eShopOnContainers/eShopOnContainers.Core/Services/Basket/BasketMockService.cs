    ...
    public class BasketMockService : IBasketService
    {
        ...
        private CustomerBasket MockCustomBasket = new CustomerBasket
        {
            ...
            Items = new List<BasketItem>
                {
                    new BasketItem { Id = "1", PictureUrl = "KampCadir1.png", ProductId = Common.Common.MockCatalogItemId01, ProductName = ".NET Bot Blue Sweatshirt (M)", Quantity = 1, UnitPrice = 19.50M },
                    new BasketItem { Id = "2", PictureUrl = "BisikletEkle1.jpg", ProductId = Common.Common.MockCatalogItemId04, ProductName = ".NET Black Cup", Quantity = 1, UnitPrice = 17.00M }
                }
        };
